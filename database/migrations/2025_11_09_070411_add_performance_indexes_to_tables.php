...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('news', function (Blueprint $table) {
            ...
            if (Schema::hasColumn('news', 'news_category_id') && !Schema::hasIndex('news', 'idx_news_category')) {
        ...
        Schema::table('gallery_comments', function (Blueprint $table) {
            ...
            if (Schema::hasColumn('gallery_comments', 'parent_id') && !Schema::hasIndex('gallery_comments', 'idx_gallery_comments_parent')) {
        ...
        Schema::table('news_comments', function (Blueprint $table) {
            ...
            if (Schema::hasColumn('news_comments', 'parent_id') && !Schema::hasIndex('news_comments', 'idx_news_comments_parent')) {
        ...
        Schema::table('visits', function (Blueprint $table) {
            ...
            if (Schema::hasColumn('visits', 'session_id') && !Schema::hasIndex('visits', 'idx_visits_session')) {
                $table->index('session_id', 'idx_visits_session');
            }
            if (Schema::hasColumn('visits', 'user_id') && !Schema::hasIndex('visits', 'idx_visits_user')) {
