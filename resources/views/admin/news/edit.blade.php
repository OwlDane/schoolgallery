...
<div class="bg-white rounded-xl shadow-sm border border-gray-100">
    <div class="p-6">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-xl font-semibold text-gray-800">Edit Berita</h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        @if($berita->image)
                            <div class="mb-4">
                                <img src="{{ asset('storage/' . $berita->image) }}" alt="{{ $berita->title }}" class="w-full h-48 object-cover rounded-lg mb-2">
                                <div class="flex items-center">
                                    ...
                                    <label for="remove_image" class="ml-2 block text-sm text-gray-700">Hapus gambar</label>
                                </div>
                            </div>
                        @endif
                    ...
                    <div class="pt-4 flex space-x-3">
                        <button type="submit" class="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg flex items-center justify-center">
                            <i class="fas fa-save mr-2"></i> Perbarui Berita
                        </button>
                        <a href="{{ route('admin.news.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium py-2 px-4 rounded-lg flex items-center justify-center">
                            Batal
                        </a>
                    </div>
                </div>
