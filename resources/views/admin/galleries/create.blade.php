...
<div class="bg-white rounded-lg shadow-sm p-6">
    <div class="mb-6">
        <h2 class="text-xl font-semibold text-gray-800">Tambah Foto Baru</h2>
        <p class="text-gray-600 mt-1">Unggah foto baru ke galeri sekolah</p>
    </div>
    ...
    <form action="{{ route('admin.galleries.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="mb-6">
            <label for="image" class="block text-sm font-medium text-gray-700 mb-1">Pilih Foto <span class="text-red-600">*</span></label>
            <div id="dropZone" class="mt-1 flex items-center justify-center px-4 py-8 bg-white text-blue-600 rounded-lg shadow-lg tracking-wide border-2 border-dashed border-blue-500 cursor-pointer hover:bg-blue-50 hover:border-blue-600 transition-all duration-300">
                <div class="text-center">
                    ...
                    <p class="text-lg font-medium mb-2">Drag & Drop foto di sini</p>
            ...
            <p class="text-sm text-gray-500 mt-2">Format yang didukung: JPG, PNG, GIF, WEBP. Ukuran maksimal: 5MB</p>
        </div>

        <div class="mb-6">
            <label class="flex items-center">
                <input type="checkbox" name="is_published" value="1" {{ old('is_published') ? 'checked' : '' }} class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
